...
void ActionManager::initFileMenuActions()
{
	...
	//File Menu
	name="fileNew";
	scrActions->insert(name, new ScrAction(im->loadIcon("16/document-new.png"), im->loadIcon("22/document-new.png"), "", defaultKey(name), mainWindow));
	name="fileNewFromTemplate";
	scrActions->insert(name, new ScrAction("", defaultKey(name), mainWindow));
	name="fileOpen";
	scrActions->insert(name, new ScrAction(im->loadIcon("16/document-open.png"), im->loadIcon("22/document-open.png"), "", defaultKey(name), mainWindow));
	name="fileClose";
	scrActions->insert(name, new ScrAction(im->loadIcon("16/close.png"), im->loadIcon("22/close.png"), "", defaultKey(name), mainWindow));
	name="fileSave";
	scrActions->insert(name, new ScrAction(im->loadIcon("16/document-save.png"), im->loadIcon("22/document-save.png"), "", defaultKey(name), mainWindow));
	name="fileSaveAs";
	scrActions->insert(name, new ScrAction(im->loadIcon("16/document-save-as.png"), im->loadIcon("22/document-save-as.png"), "", defaultKey(name), mainWindow));
	name="fileRevert";
	scrActions->insert(name, new ScrAction(im->loadIcon("revert.png"), QPixmap(), "", defaultKey(name), mainWindow));
	name="fileCollect";
	scrActions->insert(name, new ScrAction("", defaultKey(name), mainWindow));
	//File Import Menu
	name="fileImportText";
	...
	scrActions->insert(name, new ScrAction(im->loadIcon("acroread16.png"), im->loadIcon("acroread22.png"), "", defaultKey(name), mainWindow));
	//Rest of File Menu
//	name="fileDocSetup";
//	scrActions->insert(name, new ScrAction(im->loadIcon("16/document-properties.png"), im->loadIcon("22/document-properties.png"), "", defaultKey(name), mainWindow));
...
//	(*scrActions)[name]->setMenuRole(QAction::NoRole);
	...
	name="filePrint";
	scrActions->insert(name, new ScrAction(im->loadIcon("16/document-print.png"), im->loadIcon("22/document-print.png"), "", defaultKey(name), mainWindow));
	name="PrintPreview";
	scrActions->insert(name, new ScrAction(im->loadIcon("16/document-print-preview.png"), im->loadIcon("22/document-print-preview.png"), "", defaultKey(name), mainWindow));
	name="fileQuit";
	scrActions->insert(name, new ScrAction(im->loadIcon("exit.png"), QPixmap(), "", defaultKey(name), mainWindow));
...
void ActionManager::initEditMenuActions()
{
	...
	//Edit Menu
	name="editUndoAction";
	scrActions->insert(name, new ScrAction(ScrAction::DataInt, im->loadIcon("16/edit-undo.png"), im->loadIcon("22/edit-undo.png"), "", defaultKey(name), mainWindow, 1));
	name="editRedoAction";
	scrActions->insert(name, new ScrAction(ScrAction::DataInt, im->loadIcon("16/edit-redo.png"), im->loadIcon("22/edit-redo.png"), "", defaultKey(name), mainWindow, 1));
	name="editActionMode";
	scrActions->insert(name, new ScrAction("", defaultKey(name), mainWindow));
	(*scrActions)["editActionMode"]->setToggleAction(true);

	name="editCut";
	scrActions->insert(name, new ScrAction(im->loadIcon("16/edit-cut.png"), im->loadIcon("22/edit-cut.png"), "", defaultKey(name), mainWindow));
	name="editCopy";
	scrActions->insert(name, new ScrAction(im->loadIcon("16/edit-copy.png"), im->loadIcon("22/edit-copy.png"), "", defaultKey(name), mainWindow));
	name="editPaste";
	scrActions->insert(name, new ScrAction(im->loadIcon("16/edit-paste.png"), im->loadIcon("22/edit-paste.png"), "", defaultKey(name), mainWindow));
	name="editCopyContents";
	scrActions->insert(name, new ScrAction(im->loadIcon("16/edit-copy.png"), im->loadIcon("22/edit-copy.png"), "", defaultKey(name), mainWindow));
	name="editPasteContents";
	scrActions->insert(name, new ScrAction(ScrAction::DataInt, im->loadIcon("16/edit-paste.png"), QPixmap(), "", defaultKey(name), mainWindow, 0));
	name="editPasteContentsAbs";
	scrActions->insert(name, new ScrAction(ScrAction::DataInt, im->loadIcon("16/edit-paste.png"), QPixmap(), "", defaultKey(name), mainWindow, 1));
	name="editPasteImageFromClipboard";
	scrActions->insert(name, new ScrAction(im->loadIcon("16/edit-paste.png"), im->loadIcon("22/edit-paste.png"), "", defaultKey(name), mainWindow));
	name="editClearContents";
	scrActions->insert(name, new ScrAction(im->loadIcon("16/edit-delete.png"), im->loadIcon("22/edit-delete.png"), "", defaultKey(name), mainWindow));
	...
	scrActions->insert(name, new ScrAction(im->loadIcon("16/edit-find-replace.png"), im->loadIcon("22/edit-find-replace.png"), "", defaultKey(name), mainWindow));
...
void ActionManager::initItemMenuActions()
{
	...
	scrActions->insert(name, new ScrAction(im->loadIcon("16/go-bottom.png"), im->loadIcon("22/go-bottom.png"), "", defaultKey(name), mainWindow));
	name="itemRaiseToTop";
	scrActions->insert(name, new ScrAction(im->loadIcon("16/go-top.png"), im->loadIcon("22/go-top.png"), "", defaultKey(name), mainWindow));
	name="itemLower";
	scrActions->insert(name, new ScrAction(im->loadIcon("16/go-down.png"), im->loadIcon("22/go-down.png"), "", defaultKey(name), mainWindow));
	name="itemRaise";
	scrActions->insert(name, new ScrAction(im->loadIcon("16/go-up.png"), im->loadIcon("22/go-up.png"), "", defaultKey(name), mainWindow));
	...
	scrActions->insert(name, new ScrAction(im->loadIcon("16/insert-table-rows.png"), im->loadIcon("22/insert-table-rows.png"), "", defaultKey(name), mainWindow));
	name="tableInsertColumns";
	scrActions->insert(name, new ScrAction(im->loadIcon("16/insert-table-columns.png"), im->loadIcon("22/insert-table-columns.png"), "", defaultKey(name), mainWindow));
	name="tableDeleteRows";
	scrActions->insert(name, new ScrAction(im->loadIcon("16/delete-table-rows.png"), im->loadIcon("22/delete-table-rows.png"), "", defaultKey(name), mainWindow));
	name="tableDeleteColumns";
	scrActions->insert(name, new ScrAction(im->loadIcon("16/delete-table-columns.png"), im->loadIcon("22/delete-table-columns.png"), "", defaultKey(name), mainWindow));
	name="tableMergeCells";
	scrActions->insert(name, new ScrAction(im->loadIcon("16/merge-table-cells.png"), im->loadIcon("22/merge-table-cells.png"), "", defaultKey(name), mainWindow));
	name="tableSplitCells";
	scrActions->insert(name, new ScrAction(im->loadIcon("16/split-table-cells.png"), im->loadIcon("22/split-table-cells.png"), "", defaultKey(name), mainWindow));
...
void ActionManager::initViewMenuActions()
{
	...
	name="viewFit100";
	scrActions->insert(name, new ScrAction(ScrAction::DataDouble, im->loadIcon("16/zoom-original.png"), im->loadIcon("22/zoom-original.png"), "", defaultKey(name), mainWindow, 100.0));
	name="viewFit200";
	scrActions->insert(name, new ScrAction(ScrAction::DataDouble, QPixmap(), QPixmap(), "", defaultKey(name), mainWindow, 200.0));
	name="viewFit400";
	...
	scrActions->insert(name, new ScrAction(im->loadIcon("previewOn.png"), im->loadIcon("previewOn.png"), "", defaultKey(name), mainWindow));
	name="viewEditInPreview";
	scrActions->insert(name, new ScrAction(im->loadIcon("16/editdoc.png"), im->loadIcon("16/editdoc.png"), "", defaultKey(name), mainWindow));
	name="viewToggleCMS";
	scrActions->insert(name, new ScrAction(im->loadIcon("cmsOn.png"), im->loadIcon("cmsOn.png"), "", defaultKey(name), mainWindow));
...
void ActionManager::initToolsMenuActions()
{
	...
	scrActions->insert(name, new ScrAction(ScrAction::DataInt, im->loadIcon("16/measure.png"), im->loadIcon("22/measure.png"), "", defaultKey(name), mainWindow, modeMeasurementTool));
	name="toolsActionHistory";
	scrActions->insert(name, new ScrAction("", defaultKey(name), mainWindow));
	name="toolsPreflightVerifier";
	scrActions->insert(name, new ScrAction(im->loadIcon("16/preflight-verifier.png"), im->loadIcon("22/preflight-verifier.png"),"", defaultKey(name), mainWindow));
	...
	//toolbar only items
	name="toolsSelect";
	scrActions->insert(name, new ScrAction(ScrAction::DataInt, im->loadIcon("16/pointer.png"), im->loadIcon("22/pointer.png"), "", defaultKey(name), mainWindow, modeNormal));
	name="toolsInsertTextFrame";
	scrActions->insert(name, new ScrAction(ScrAction::DataInt, im->loadIcon("16/insert-text-frame.png"), im->loadIcon("22/insert-text-frame.png"), "", defaultKey(name), mainWindow, modeDrawText));
	name="toolsInsertImageFrame";
	scrActions->insert(name, new ScrAction(ScrAction::DataInt, im->loadIcon("16/insert-image.png"), im->loadIcon("22/insert-image.png"), "", defaultKey(name), mainWindow, modeDrawImage));
	name="toolsInsertRenderFrame";
	scrActions->insert(name, new ScrAction(ScrAction::DataInt, im->loadIcon("16/insert-renderframe.png"), im->loadIcon("22/insert-renderframe.png"), "", defaultKey(name), mainWindow, modeDrawLatex));
	name="toolsInsertTable";
	scrActions->insert(name, new ScrAction(ScrAction::DataInt, im->loadIcon("16/insert-table.png"), im->loadIcon("22/insert-table.png"), "", defaultKey(name), mainWindow, modeDrawTable2));
	...
	scrActions->insert(name, new ScrAction(ScrAction::DataInt, im->loadIcon("16/draw-polygon.png"), im->loadIcon("22/draw-polygon.png"), "", defaultKey(name), mainWindow, modeDrawRegularPolygon));
	name="toolsInsertArc";
	scrActions->insert(name, new ScrAction(ScrAction::DataInt, im->loadIcon("16/draw-arc.png"), im->loadIcon("22/draw-arc.png"), "", defaultKey(name), mainWindow, modeDrawArc));
	...
	scrActions->insert(name, new ScrAction(ScrAction::DataInt, im->loadIcon("16/draw-freehand.png"), im->loadIcon("22/draw-freehand.png"), "", defaultKey(name), mainWindow, modeDrawFreehandLine));
	name="toolsInsertCalligraphicLine";
	scrActions->insert(name, new ScrAction(ScrAction::DataInt, im->loadIcon("16/draw-calligraphic.png"), im->loadIcon("22/draw-calligraphic.png"), "", defaultKey(name), mainWindow, modeDrawCalligraphicLine));
	name="toolsRotate";
	scrActions->insert(name, new ScrAction(ScrAction::DataInt, im->loadIcon("16/transform-rotate.png"), im->loadIcon("22/transform-rotate.png"), "", defaultKey(name), mainWindow, modeRotation));
	name="toolsZoom";
	scrActions->insert(name, new ScrAction(ScrAction::DataInt, im->loadIcon("16/zoom.png"), im->loadIcon("22/zoom.png"), "", defaultKey(name), mainWindow, modeMagnifier));
	name="toolsZoomIn";
	scrActions->insert(name, new ScrAction(im->loadIcon("16/zoom-in.png"), im->loadIcon("22/zoom-in.png"), "", defaultKey(name), mainWindow));
	name="toolsZoomOut";
	...
	scrActions->insert(name, new ScrAction(ScrAction::DataInt, im->loadIcon("16/text-frame-link.png"), im->loadIcon("22/text-frame-link.png"), "", defaultKey(name), mainWindow, modeLinkFrames));
	name="toolsUnlinkTextFrame";
	scrActions->insert(name, new ScrAction(ScrAction::DataInt, im->loadIcon("16/text-frame-unlink.png"), im->loadIcon("22/text-frame-unlink.png"), "", defaultKey(name), mainWindow, modeUnlinkFrames));
	name="toolsEyeDropper";
	scrActions->insert(name, new ScrAction(ScrAction::DataInt, im->loadIcon("16/color-picker.png"), im->loadIcon("22/color-picker.png"), "", defaultKey(name), mainWindow, modeEyeDropper));
	name="toolsCopyProperties";
	scrActions->insert(name, new ScrAction(ScrAction::DataInt, im->loadIcon("wizard16.png"), im->loadIcon("wizard.png"), "", defaultKey(name), mainWindow, modeCopyProperties));
	...
	scrActions->insert(name, new ScrAction(ScrAction::DataInt, im->loadIcon("16/insert-button.png"), im->loadIcon("22/insert-button.png"), "", defaultKey(name), mainWindow, modeInsertPDFButton));
	name="toolsPDFRadioButton";
	scrActions->insert(name, new ScrAction(ScrAction::DataInt, im->loadIcon("16/radiobutton.png"), im->loadIcon("22/radiobutton.png"), "", defaultKey(name), mainWindow, modeInsertPDFRadioButton));
	name="toolsPDFTextField";
	scrActions->insert(name, new ScrAction(ScrAction::DataInt, im->loadIcon("16/text-field.png"), im->loadIcon("22/text-field.png"), "", defaultKey(name), mainWindow, modeInsertPDFTextfield));
	name="toolsPDFCheckBox";
	scrActions->insert(name, new ScrAction(ScrAction::DataInt, im->loadIcon("16/checkbox.png"), im->loadIcon("22/checkbox.png"), "", defaultKey(name), mainWindow, modeInsertPDFCheckbox));
	name="toolsPDFComboBox";
	scrActions->insert(name, new ScrAction(ScrAction::DataInt, im->loadIcon("16/combobox.png"), im->loadIcon("22/combobox.png"), "", defaultKey(name), mainWindow, modeInsertPDFCombobox));
	name="toolsPDFListBox";
	scrActions->insert(name, new ScrAction(ScrAction::DataInt, im->loadIcon("16/list-box.png"), im->loadIcon("22/list-box.png"), "", defaultKey(name), mainWindow, modeInsertPDFListbox));
	name="toolsPDFAnnotText";
	scrActions->insert(name, new ScrAction(ScrAction::DataInt, im->loadIcon("16/pdf-annotations.png"), im->loadIcon("22/pdf-annotations.png"), "", defaultKey(name), mainWindow, modeInsertPDFTextAnnotation));
	name="toolsPDFAnnotLink";
	scrActions->insert(name, new ScrAction(ScrAction::DataInt, im->loadIcon("goto16.png"), im->loadIcon("goto.png"), "", defaultKey(name), mainWindow, modeInsertPDFLinkAnnotation));
#ifdef HAVE_OSG
	name="toolsPDFAnnot3D";
	scrActions->insert(name, new ScrAction(ScrAction::DataInt, im->loadIcon("16/annot3d.png"), im->loadIcon("22/annot3d.png"), "", defaultKey(name), mainWindow, modeInsertPDF3DAnnotation));
#endif
...
void ActionManager::initHelpMenuActions()
{
	...
	scrActions->insert(name, new ScrAction("", defaultKey(name), mainWindow));
	name="helpManual";
	scrActions->insert(name, new ScrAction(im->loadIcon("16/help-browser.png"), QPixmap(), "", defaultKey(name), mainWindow));
	name="helpOnlineWWW";
