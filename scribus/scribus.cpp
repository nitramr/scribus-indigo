...
void ScribusMainWindow::setStyleSheet()
{
    ...
    if(sysTheme.contains(sTheme)){
		...
		if (loadRawText(ScPaths::applicationDataDir() + "/stylesheet.css", stylesheet))
        {
...
void ScribusMainWindow::initPalettes()
{
	...
	// Text
	textPalette = new TextPalette(this, "TextProperties");
	textPalette->setMainWindow(this);
	wdg_indigoDockManager->addIndigoPanel(wdg_indigoDock, textPalette);
